"""
Iron Teeth faction tab for the Timberborn Calculator.
"""
...
class IronTeethTab:
    """Iron Teeth faction calculator tab."""

    def __init__(self, parent):
        """
        Initialize the Iron Teeth tab.
    ...
    def _setup_ui(self):
        """Set up the UI components for the Iron Teeth tab."""
        # Main container
    ...
    def _create_food_water_section(self, parent):
        ...
        # Target population section (no beehive checkbox for Iron Teeth)
    ...
    def _create_water_section(self, parent):
        ...
        ttk.Label(header_frame, text="Building", width=20).pack(side=tk.LEFT)
        ttk.Label(header_frame, text="Needs", width=10).pack(side=tk.LEFT)

        # Deep Water Pumps row (Iron Teeth specific)
        self._create_water_building_row(water_frame, "Deep Water Pumps")
    ...
    def _create_water_building_row(self, parent, building_name):
        ...
        # Building label
        ttk.Label(row_frame, text=building_name, width=20).pack(side=tk.LEFT)
    ...
    def _create_food_section(self, parent):
        ...
        # Iron Teeth food items
        food_items = [
            ("Grilled Mushrooms", "Grill", "Mushrooms"),
            ("Grilled Dandelions", "Grill", "Dandelions"),
        ]
    ...
    def _create_goods_section(self, parent):
        ...
        # Goods items for Iron Teeth
        goods_items = [
            ("Planks", "Industrial Lumber Mill", "Logs"),
